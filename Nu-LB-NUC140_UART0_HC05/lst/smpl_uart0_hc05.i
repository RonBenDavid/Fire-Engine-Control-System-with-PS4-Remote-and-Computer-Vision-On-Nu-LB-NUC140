...
void InitPWM()
{
             ...
             ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PWM01_EN =1;  
	           ...
	           ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR0=(12000000 / 50);           
	           ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0=0x8000;		        
             ...
             ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PWM01_EN =1;  
	           ...
	           ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR1=(12000000 / 50);           
	           ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1=0x8000;		        
   ...
   strcpy(Backward_STR, "D");
	...
	while(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR.RDA_IF==1) 
	{
		...
		if (comRbytes==7) {	
			...
			DrvUART_Write(UART_PORT0,(uint8_t *) TEXT2,strlen(TEXT2));	
			}
			...
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0=((12000000 / 50) / 256) *Speed_PWM_INT;
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1=((12000000 / 50) / 256) *Speed_PWM_INT;
